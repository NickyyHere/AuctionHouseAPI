...
{
    public class GetAuctionItemByIdQueryTests
    {
        private Mock<IAuctionRepository> repository;
        private Mock<IMapper> mapper;
        private GetAuctionItemByIdHandler handler;
        ...
        public void Setup()
        {
            ...
            handler = new GetAuctionItemByIdHandler(repository.Object, mapper.Object);
        }

        [Test]
        public async Task ShouldGetAuctionAndMapToDTO()
        {
            var query = new GetAuctionItemByIdQuery(1);
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(result, Is.EqualTo(auctionDTO.Item));
            }
            );
