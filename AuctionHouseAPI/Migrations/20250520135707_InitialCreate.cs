        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsIncreamentalOnLastMinuteBid = table.Column<bool>(type: "boolean", nullable: false),
                    MinutesToIncrement = table.Column<int>(type: "integer", nullable: false),
                    MinimumOutbid = table.Column<int>(type: "integer", nullable: false),
                    AllowBuyItNow = table.Column<bool>(type: "boolean", nullable: false),
                    BuyItNowPrice = table.Column<decimal>(type: "numeric", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuctionOptions", x => x.AuctionId);
                    table.ForeignKey(
                        name: "FK_AuctionOptions_Auctions_AuctionId",
                        column: x => x.AuctionId,
                        principalTable: "Auctions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemTags", x => new { x.AuctionItemId, x.TagId });
                    table.ForeignKey(
                        name: "FK_ItemTags_AuctionItems_AuctionItemId",
